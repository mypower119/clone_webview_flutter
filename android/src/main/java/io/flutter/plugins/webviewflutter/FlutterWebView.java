...
//    //shin thêm
    ...
    RelativeLayout.LayoutParams webviewPram = new RelativeLayout.LayoutParams(
            RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);

    final float scale = context.getResources().getDisplayMetrics().density;
    int pixels = (int) (325 * scale + 0.5f);
    ...
    webView.setLayoutParams(webviewPram);

    RelativeLayout relativeLayout = new RelativeLayout(context);

    RelativeLayout.LayoutParams relaParam = new RelativeLayout.LayoutParams(
            pixels, RelativeLayout.LayoutParams.MATCH_PARENT);
    relativeLayout.setLayoutParams(relaParam);
  ...
  public static Bitmap screenCapture(ScrollView scrollView) {
    try {
  ...
  public void onMethodCall(MethodCall methodCall, Result result) {
    switch (methodCall.method) {
      ...
      case "getTitle":
        getTitle(result);
        break;
      case "getCaptureScreenBase64":
        Bitmap bitmap = screenCapture(scroll);
